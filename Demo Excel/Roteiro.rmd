...
Na área de VISUALIZAÇÕES (volte para a primeira opção no menu da esquerda no Power BI), escolha a visualização para colocar filtros, depois, procure a coluna DateTime da tabela DIM_DATA e selecione.
